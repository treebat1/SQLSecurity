...
from [10.170.145.125\DATAMARTPROD].master.sys.server_principals s 
right join [chdc-car-phsql4\datamartprod].master.sys.server_principals d
on s.sid = d.sid
...
select s.name SourceName, s.sid SourceSID, d.name DestinationName, d.sid DestinationSID
from [10.170.145.125\DATAMARTPROD].master.sys.server_principals s 
left join [chdc-car-phsql4\datamartprod].master.sys.server_principals d
on s.sid = d.sid
